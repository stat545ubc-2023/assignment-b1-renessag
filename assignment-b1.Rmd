...
The following code tests the `group_count_and_prop` function given various types of input to test the robustness of its intended use and its response to inappropriate inputs. 
...
This test evaluates if the output of `group_count_and_prop` versus `test401` are identical.
...
This test evaluates if the output of `group_count_and_prop` versus `test402` are identical.
